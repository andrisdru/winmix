...
// The tray icon and its right-click menu (Open / input-device submenu /
// Exit). Routes through a caller-chosen WM_APP message on the owning
// window rather than owning a window of its own -- the owner's WndProc
// forwards that message to OnCallback().
class TrayIcon
{
public:
